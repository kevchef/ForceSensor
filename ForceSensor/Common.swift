...
func drawCircleView() -> UIView {
    let circlePath = UIBezierPath(arcCenter: CGPoint(x: generalCenter.x ,y: generalCenter.y), radius: CGFloat(50), startAngle: CGFloat(0), endAngle:CGFloat(Double.pi * 2), clockwise: true)
